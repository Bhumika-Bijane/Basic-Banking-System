  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #88BDBC;">
              ...
              <div class="col-sm-6 col-md img text-right">
                <img  src="img/bank5.jpg" height="300" width="330">
              </div>
            </div>
      ...
      <!-- Activity section --> 
            <div class="row activity text-center">
                  <div class="col-md act">
                    <img src="img/user.jpg" height="245" width="245" class="img-fluid">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p> Made by <b>BHUMIKA BIJANE</b> <br>Intern At <br>The Spark Foundation</p>
      </footer>
